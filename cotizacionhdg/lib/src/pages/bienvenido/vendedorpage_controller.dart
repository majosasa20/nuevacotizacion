...
class VendedorPageController{
  ...
  void goToMenuVendedor(idempresa,nombreempresa){
    _sharedPref.save('idEmpresa', idempresa);
    _sharedPref.save('nombreEmpresa', nombreempresa);
    print('mandar parametros $idempresa $nombreempresa');
    Map<String, dynamic> parametros = {
      "idEmpresa": idempresa,
      "nombreEmpresa": nombreempresa,
    };
    Navigator.pushNamed(context!, 'menuvendedorpage', arguments: parametros);
